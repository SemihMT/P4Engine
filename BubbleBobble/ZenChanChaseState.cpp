...
dae::ZenChanChaseState::ZenChanChaseState(GameObject* owner) :
	State(owner),
...
dae::ZenChanChaseState::~ZenChanChaseState()
{
}

void dae::ZenChanChaseState::OnEnter()
{
...
void dae::ZenChanChaseState::OnExit()
{
}

void dae::ZenChanChaseState::Update()
{
...
void dae::ZenChanChaseState::DecideNextAction()
{
...
void dae::ZenChanChaseState::MoveRight(float dt)
{
	m_ownerTransform->Translate(m_speed * dt, 0, 0);
    m_ownerTransform->SetForwardDirection({1,0,0});
}

void dae::ZenChanChaseState::MoveLeft(float dt)
{
	m_ownerTransform->Translate(-m_speed * dt, 0, 0);
    m_ownerTransform->SetForwardDirection({-1,0,0});
...
void dae::ZenChanChaseState::Jump()
{
	m_ownerRb->Jump();
